                                ...
                                <div className="bg-white shadow-sm border border-black p-6 sticky top-8">
                                    ...
                                    <div className="mt-6 space-y-3">
                                        <button
                                            ...
                                            className="w-full border-black border text-white py-3 px-4 bg-white transition-all duration-300 hover:bg-black hover:text-white text-sm uppercase group relative overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
