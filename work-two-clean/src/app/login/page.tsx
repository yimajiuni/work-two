        ...
        <div className="font-inter text-thin h-[calc(100vh)] px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 flex items-center justify-center">
            <div className="w-full max-w-sm">
                <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        className="bg-black border border-black font-inter text-thin text-xs uppercase py-3 text-white disabled:cursor-not-allowed disabled:opacity-50 hover:bg-white hover:text-white hover:border-black hover:border overflow-hidden group relative"
                        disabled={isLoading}
                    >
                    ...
                    {(mode === MODE.LOGIN || mode === MODE.REGISTER) && (
                        <button
                            ...
                            disabled={isLoading}
                            className="uppercase border border-gray-700 font-inter text-thin text-xs text-gray-700 p-2 disabled:cursor-not-allowed disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
                        >
