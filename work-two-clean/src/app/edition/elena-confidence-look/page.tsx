                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 w-full max-w-6xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="flex flex-col justify-center items-center text-center">
                            <h1 className="font-finches w-2/3 md:w-full text-4xl md:text-5xl text-white leading-tight mb-4">
                                Affirm, Breathe,<br />
                        ...
                        <div className="flex items-center justify-center text-center md:text-left">
                            <p className="font-thin w-2/3 md:w-full text-sm md:text-base text-white leading-relaxed max-w-sm">
                                The interplay of strength and fragility is reflected in ROA's SS 2025 collection through its combinations of hard wearing fabrics with elements of lightness and flexibility, in an eclectic experimentation that highlights the connections between form and function, past and present, natural environments and city dwellings.
                            </p>
                        </div>
                    </div>
                </div>
