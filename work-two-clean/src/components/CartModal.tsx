                    ...
                    {items.length > 0 ? (
                        <div className="border-t border-gray-200 p-6 space-y-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <button
                                    className={`w-full border border-gray-900 py-3 px-4 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-xs uppercase group relative overflow-hidden ${isViewCartHovered
                                        ? 'text-black bg-white'
