                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className={`w-[190px] px-2 border transition-all duration-300 text-xs font-medium font-inter disabled:cursor-not-allowed relative overflow-hidden group ${isOutOfStock
