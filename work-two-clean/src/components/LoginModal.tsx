                ...
                <div className="flex flex-col p-6 max-h-[calc(100vh-300px)]">
                    ...
                    <div className="p-6 border-t border-gray-200 space-y-4">
                        ...
                        <button
                            onClick={handleLogin}
                            disabled={isLoading}
                            className="bg-black text-white hover:bg-white hover:text-white hover:border-black hover:border disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden group relative w-full py-3 px-4 text-xs"
                        >
                            {/*和柄ボタン背景*/}
