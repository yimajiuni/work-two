                        ...
                        <div className="gap-1 absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-center opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                            ...
                            {showCheckProduct ? (
                                ...
                                <button
                                    ...
                                    className={`w-[250px] px-3 py-3 transition-all duration-300 text-xs font-medium font-inter disabled:cursor-not-allowed ${!selectedVariant?.availableForSale || (selectedVariant?.quantityAvailable !== undefined && selectedVariant.quantityAvailable < 1)
                                        ? 'bg-black text-white'
