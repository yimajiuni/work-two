...
const classes = {
    ...
    // Decorative elements
    decorativeContainer: "fixed inset-0 w-full min-w-[24rem] top-[48%] sm:top-[58%] lg:top-[50%] max-w-[82rem] left-1/2 transform -translate-x-1/2 z-40 pointer-events-none",
