...
年代が対象`,
  ...
  },
  {
    ...
    concept_eva:
      "ツアーの魅力がより明確にリアルに伝わり、思い立ったら予約出来る、ブッキングウェブサイト。",
    persona_basic: "男女＋年代:健康な全年齢、ファミリー層、核家族、拡大家族 ",
  ...
  },
  {
    ...
    concept_needs:
      "店舗の雰囲気と料理の美味しさが伝わる、温かみのある色彩とフォントを使用しながら、合理的なレイアウトで視覚的にも料理の美しさを引き立てるデザインを心掛けました。 ",
    concept_function:
