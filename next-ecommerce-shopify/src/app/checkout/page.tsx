                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-lg shadow-sm p-6 sticky top-8">
                            ...
                            <button
                                ...
                                className="w-full bg-highlight text-white py-3 px-4 rounded-md font-medium hover:bg-opacity-90 transition-colors disabled:opacity-50 disabled:cursor-default mt-6"
                            >
                                {isRedirecting ? (
