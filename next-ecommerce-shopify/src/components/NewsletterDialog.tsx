                                ...
                                <form onSubmit={handleUnlockOffer} className="space-y-2">
                                    ...
                                    <div className="flex flex-col sm:flex-row relative">
                                        <button
                                            ...
                                            className="flex-1 bg-black border border-black text-white font-inter text-thin text-xs py-2 px-4 transition-colors duration-200 disabled:cursor-default uppercase hover:bg-white hover:text-white hover:border-black hover:border overflow-hidden group relative"
                                        >
